...
class Transfer(BaseUserModel):
	...
	source = ForeignKey('modes_of_payment.ModeOfPayment', PROTECT, related_name='source')
	destination = ForeignKey('modes_of_payment.ModeOfPayment', PROTECT, related_name='destination')
