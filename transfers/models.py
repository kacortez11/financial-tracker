...
class Transfer(BaseUserModel):
	...
	source = ForeignKey('mode_of_payments.ModeOfPayment', PROTECT, related_name='source_id')
	destination = ForeignKey('mode_of_payments.ModeOfPayment', PROTECT, related_name='destination_id')
