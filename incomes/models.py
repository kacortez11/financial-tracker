...
class Income(BaseUserModel):
	...
	source = ForeignKey('categories.Category', PROTECT, related_name='source_of_income_id')
	amount = DecimalField(decimal_places=2, max_digits=32, blank=False)
	details = TextField(null=True)
	mode_of_payment = ForeignKey('mode_of_payments.ModeOfPayment', PROTECT, related_name='income_mode_of_payment_id')
